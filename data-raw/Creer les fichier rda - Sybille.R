...
for (ess in liste_ess_arbre) {
  ...
  alpha <- read_delim(paste0("data-raw/Parametre_eq_defil/Modele_arbre/", ess,"/parameters",ess,".csv"), delim=';' ) %>% slice(1) %>% select(x)
...
data_diam1 <- data.frame(essence=c('BOP','EPB','EPN','EPR','PEG','PET','PIB','PIG','SAB','THO', 'ERS'),
...
data_diam2 <- data.frame(essence=rep('BOP',11),
                         id_pe = seq(1,11,1),
                         no_arbre = rep(1,11),
...
data_diam4 <- data.frame(essence=rep(c('BOP','EPB','EPN','EPR','PEG','PET','PIG','SAB','THO'), 100000),
...
data_diam5 <- data.frame(essence=rep(c('BOP','EPB','EPN','EPR','PEG','PET','PIB','PIG','SAB','THO','ERS'), 4000),
                         id_pe = seq(1, 44000, 1),
...
data_diam7 <- data.frame(essence=rep(c('BOP','EPB','EPN','EPR','PEG','PET','PIB','PIG','SAB','THO','ERS'), 50000),
...
data_diam9 <- data.frame(essence=rep(c('BOP','EPB','EPN','EPR','PEG','PET','PIB','PIG','SAB','THO','ERS'), 50),
                         id_pe = seq(1, 550, 1),
                         no_arbre = seq(1, 550, 1),
                         sdom_bio = rep(c('2EST','2OUEST','3EST','3OUEST','4EST','4OUEST','5EST','5OUEST','6EST','6OUEST','1'), 50),
                         cl_drai = rep(c('2','4','1','3','5','6','0','1','2','3','4'), 50),
...
data_diam12 <- data.frame(essence = rep(c('BOP'), 3),
                          id_pe = rep(1, 3),
                          no_arbre = 1:3,
