...
test_that("calcul_vol_bille retourne une data.table vide si l'entrée est vide", {
  ...
  donnees_vide <- data.frame(
    ...
    st_ha = numeric(0),
    ALTITUDE = numeric(0),
    nom_grade1 = character(0),
    long_grade1 = numeric(0),
    diam_grade1 = numeric(0),
    nom_grade2 = character(0),
    long_grade2 = numeric(0),
    diam_grade2 = numeric(0),
    nom_grade3 = character(0),
    long_grade3 = numeric(0),
    diam_grade3 = numeric(0),
...
test_that("calcul_vol_bille retourne une data.table vide si l'entrée ne contient que des essences qui ne sont pas dans defil_liste_ess", {
...
test_that("calcul_vol_bille retourne une data.table vide si l'entrée ne contient que long_grade plus grand que les hauteurs", {
...
test_that("calcul_vol_bille retourne une data.table vide si l'entrée ne contient que diam_value plus grand que les diamètres prédits", {
  data_billes <- data.frame(essence = rep(c('BOP'), 3),
                            id_pe = rep(1, 3),
                            no_arbre = 1:3,
                            sdom_bio = rep(c("3OUEST"), 3),
