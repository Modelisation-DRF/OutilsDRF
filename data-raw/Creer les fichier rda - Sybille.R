...
data_diam4 <- data.frame(essence=c('BOP','EPB','EPN','EPR','PEG','PET','PIG','SAB','THO'),
                         id_pe = seq(1,9,1),
                         no_arbre = rep(1:3, 3),
                         sdom_bio = c('2EST','2OUEST','3EST','3OUEST','4EST','4OUEST','5OUEST','6EST','6OUEST'),
                         cl_drai = c('2','4','1','3','5','6','1','2','3'),
                         veg_pot = c('MS2','RE3','MJ2','FE2','RE2','RE1','RB2','MS1','RS2'),
                         DHP_Ae = rep(150, 9),
                         HT_REELLE_M = rep(9:11, 3),
                         HAUTEUR_M = rep(5:7, 3),
                         nbTi_ha = 2000,
                         st_ha = 15,
                         ALTITUDE = 200,
